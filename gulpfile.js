...
// optimizePng deleted
import {optimizeSvg, sprite, createWebp, optimizeJpg} from './gulp/optimizeImages.mjs';
...
// optimizePng deleted
const build = gulp.series(clean, copy, sprite, gulp.parallel(styles, js, optimizeJpg, optimizeSvg));
// optimizePng deleted
const dev = gulp.series(clean, copy, sprite, gulp.parallel(styles, js, optimizeJpg, optimizeSvg), syncServer);
